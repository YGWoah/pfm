...
const createArticle = async (req: Request, res: Response) => {
	...
	ArticleModel.createArticle(titre, contenu, categorie, userId, image, published)
...
const updateArticle = (req: Request, res: Response) => {
	...
	ArticleModel.updateArticle(parseInt(id), titre, contenu, categorieId)
		.then((article: Article) => {
			res.json(article);
		})
		.catch((error) => {
...
const deleteArticle = (req: Request, res: Response) => {
	...
	ArticleModel.deleteArticle(parseInt(id))
		.then((article: Article) => {
			res.json(article);
		})
		.catch((error) => {
